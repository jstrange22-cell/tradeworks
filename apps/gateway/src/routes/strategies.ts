...
const STRATEGY_TEMPLATES = [
  ...
  },
  {
    ...
    description: 'Detects consolidation breakouts using ATR volatility channels across the top 20 crypto assets. Enters when price breaks out of a tight range with volume confirmation.',
    type: 'breakout',
    strategyType: 'custom',
    market: 'crypto',
    instruments: [
      'BTC-USD', 'ETH-USD', 'SOL-USD', 'XRP-USD', 'BNB-USD',
      'AVAX-USD', 'LINK-USD', 'DOT-USD', 'UNI-USD', 'DOGE-USD',
      'MATIC-USD', 'ATOM-USD', 'LTC-USD', 'ADA-USD', 'NEAR-USD',
      'FIL-USD', 'AAVE-USD', 'APT-USD', 'ARB-USD', 'OP-USD',
    ],
    timeframes: ['15m', '1h'],
  ...
  {
    id: 'tpl-altcoin-momentum',
    name: 'Altcoin Momentum Scanner',
    description: 'Scans the top 30 altcoins for the strongest 24-hour momentum. Enters the top 5 performers and rides the trend. Rotates weekly to catch the next hot coin cycle.',
    type: 'momentum',
    strategyType: 'momentum',
    market: 'crypto',
    instruments: [
      'XRP-USD', 'BNB-USD', 'AVAX-USD', 'LINK-USD', 'DOT-USD',
      'UNI-USD', 'MATIC-USD', 'ATOM-USD', 'LTC-USD', 'ADA-USD',
      'NEAR-USD', 'FIL-USD', 'AAVE-USD', 'APT-USD', 'ARB-USD',
      'OP-USD', 'INJ-USD', 'SUI-USD', 'TIA-USD', 'JUP-USD',
      'WIF-USD', 'BONK-USD', 'PEPE-USD', 'FLOKI-USD', 'PYTH-USD',
      'JTO-USD', 'RNDR-USD', 'GRT-USD', 'IMX-USD', 'BLUR-USD',
    ],
    timeframes: ['1h', '4h'],
    parameters: { lookbackHours: 24, topN: 5, minMomentum: 0.05, rsiOversold: 35 },
    riskOverrides: { maxRiskPercent: 0.8, maxPositionSize: 0.2 },
    difficulty: 'intermediate' as const,
  },
  {
    id: 'tpl-defi-bluechips',
    name: 'DeFi Blue Chips',
    description: 'Trades the leading DeFi protocol tokens using mean reversion. Buys dips in battle-tested protocols (Uniswap, Aave, Curve, MakerDAO). Best during DeFi season rotations.',
    type: 'mean_reversion',
    strategyType: 'mean_reversion',
    market: 'crypto',
    instruments: ['UNI-USD', 'AAVE-USD', 'CRV-USD', 'MKR-USD', 'COMP-USD', 'SNX-USD', 'BAL-USD', 'YFI-USD', 'LDO-USD', 'RPL-USD'],
    timeframes: ['4h', '1d'],
    parameters: { period: 20, stdDev: 2.0, entryDeviation: -1.5, exitDeviation: 0.5 },
    riskOverrides: { maxRiskPercent: 0.7, maxPositionSize: 0.15 },
    difficulty: 'intermediate' as const,
  },
  {
    id: 'tpl-layer1-rotation',
    name: 'Layer 1 Rotation',
    description: 'Rotates between competing Layer 1 blockchains based on relative strength. Buys the laggards catching up and sells the overextended leaders. Captures inter-chain capital flows.',
    type: 'momentum',
    strategyType: 'momentum',
    market: 'crypto',
    instruments: ['SOL-USD', 'AVAX-USD', 'NEAR-USD', 'APT-USD', 'SUI-USD', 'INJ-USD', 'TIA-USD', 'SEI-USD', 'MINA-USD', 'ALGO-USD'],
    timeframes: ['4h', '1d'],
    parameters: { relativeStrengthLookback: 14, rotationThreshold: 0.03, minRSI: 40, maxRSI: 70 },
    riskOverrides: { maxRiskPercent: 1.0, maxPositionSize: 0.2 },
    difficulty: 'advanced' as const,
  },
  {
    id: 'tpl-meme-momentum',
    name: 'Meme Coin Momentum',
    description: 'Captures explosive moves in meme coins using strict momentum and volume filters. High risk, high reward — only enter on confirmed volume spikes. Tight stops required.',
    type: 'momentum',
    strategyType: 'momentum',
    market: 'crypto',
    instruments: ['DOGE-USD', 'SHIB-USD', 'PEPE-USD', 'FLOKI-USD', 'WIF-USD', 'BONK-USD'],
    timeframes: ['15m', '1h'],
    parameters: { volumeThreshold: 3.0, momentumLookback: 4, minGain: 0.08, stopLoss: -0.12 },
    riskOverrides: { maxRiskPercent: 0.5, maxPositionSize: 0.1 },
    difficulty: 'advanced' as const,
  },
];
